...
include '../koneksi.php';
$ambil = mysqli_query($koneksi, "SELECT * FROM data_pelanggan WHERE id_pelanggan = $_SESSION[id]");
        ...
        <aside id="leftsidebar" class="sidebar">
            ...
            <div class="user-info">
                ...
                <div class="info-container">
                    <div class="name" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Pelanggan</div>
                    <div class="email"><?= $nama['nama_pelanggan'] ?></div>
                    <div class="btn-group user-helper-dropdown">
                        <i class="material-icons" data-toggle="dropdown" aria-haspopup="true" aria-expanded="true">keyboard_arrow_down</i>
                        <ul class="dropdown-menu pull-right">
                            <li><a href="data_pelanggan.php"><i class="material-icons">person</i>Profile</a></li>
