...
$pdf->SetX(4);            
$pdf->MultiCell(19.5,0.5,'LAPORAN DATA NILAI PELANGGAN DAV NET',0,'L');    
...
$pdf->Cell(0,0.7,'Laporan Data Nilai Pelanggan DAV Net',0,0,'C');
$pdf->ln(1);
$pdf->SetFont('Arial','B',10);
...
while($data=mysqli_fetch_array($query)){
  ...
  $pdf->Cell(1.5, 0.8, $no , 1, 0, 'C');
  $pdf->Cell(9, 0.8, $data['nama_pelanggan'],1, 0, 'C');
...
$pdf->Output("laporan_data_nilai.pdf","I");
