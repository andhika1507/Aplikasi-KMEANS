  ...
  $('.select-wrapper.md-form.md-outline input.select-dropdown').bind('focus blur', function () {
    ...
    var myChart = new Chart(ctx, {
      type: 'bar',
      data: {
        labels: ["Potensial", "Tidak Potensial"],
        datasets: [{
          label: '',
          data: [
          <?php 
          $jumlah1 = mysqli_query($koneksi,"SELECT * FROM data_nilai WHERE Cluster = 'Cluster-1'");
          echo mysqli_num_rows($jumlah1);
          ?>, 
          <?php 
          $jumlah2 = mysqli_query($koneksi,"SELECT * FROM data_nilai WHERE Cluster = 'Cluster-2'");
